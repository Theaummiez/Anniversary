            ...
            if (key === "del") {
              return (
                <button
                  ...
                  className="flex items-center justify-center h-14 rounded-xl text-white/50 hover:text-white/80 hover:bg-white/[0.04] active:bg-white/[0.08] transition-all duration-150 disabled:opacity-20 disabled:cursor-default focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pink-500"
