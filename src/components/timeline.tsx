      ...
      <div className="relative max-w-2xl w-full">
        ...
        {TIMELINE_EVENTS.map((event, i) => {
          ...
          return (
            ...
            >
              <Card className="flex-1 bg-white/5 border-pink-500/15 backdrop-blur-xl p-5 hover:border-pink-400 hover:shadow-[0_0_32px_rgba(255,107,157,0.14)] transition-all duration-300">
